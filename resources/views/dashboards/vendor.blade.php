...
<body class="bg-neutral-50 min-h-screen">
            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="text-right">
                        ...
                        <div class="text-xs text-neutral-500">Vendor</div>
                    </div>
    ...
    <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-md p-8 mb-8">
            <h1 class="text-4xl font-bold text-neutral-900 mb-2">Dashboard Vendor 🏪</h1>
            <p class="text-lg text-neutral-600">Selamat datang, <span class="font-semibold text-red-600">{{ Auth::user()->name }}</span></p>
            <p class="text-sm text-neutral-500 mt-2">{{ Auth::user()->store_name }}</p>
        </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h3 class="font-semibold text-blue-900 mb-1">Dashboard Vendor Segera Hadir</h3>
                    <p class="text-sm text-blue-800">Fitur untuk melihat dan mengelola pesanan yang ditujukan ke vendor Anda sedang dalam pengembangan.</p>
                    <p class="text-sm text-blue-700 mt-2">Fitur yang akan tersedia:</p>
                    <ul class="list-disc list-inside text-sm text-blue-700 mt-1 space-y-1">
                        <li>Melihat pesanan yang ditujukan ke vendor Anda</li>
                        <li>Menerima atau menolak pesanan</li>
