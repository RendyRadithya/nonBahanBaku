<x-app-layout>
    <div class="max-w-7xl mx-auto px-6 py-6">
        ...
        <div class="flex items-start justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
                <button onclick="exportToExcel()" class="inline-flex items-center gap-2 px-4 py-2.5 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition">
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            // For now just alert - you can implement actual export later
