        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <a href="{{ route('vendor.history.export', request()->query()) }}" 
                    class="mt-4 sm:mt-0 inline-flex items-center px-3 py-2 sm:px-4 sm:py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-semibold shadow-md w-auto max-w-max whitespace-nowrap">
